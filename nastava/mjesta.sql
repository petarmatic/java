...
select * from mjesto where postanskibroj like '3130%';
select * from mjesto where naziv='Grabovac';

select count(*) from mjesto where zupanija=14;
	
select * from mjesto where naziv like 'ka%';
insert into  mjesto  (postanskibroj,zupanija,naziv) values ('23123',14,'Keritovac');
